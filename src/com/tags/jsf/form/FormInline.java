...
@FacesComponent(createTag = true, namespace="http://www.edunola.com.ar/uicomponents", tagName="formInline", value="formInline")
public class FormInline extends UIComponentBase{
	private String id;
    ...
    public void encodeBegin(FacesContext context) throws IOException {
        ...
        writer.write(api.imprimirComponente("form_inline", valores));
    }
