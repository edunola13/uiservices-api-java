...
@FacesComponent(createTag = true, namespace="http://www.edunola.com.ar/uicomponents", tagName="select", value="select")
public class Select extends UIComponentBase{
    ...
    public void encodeBegin(FacesContext context) throws IOException {
		...
		this.getAttributes().put("typeSelect", "simple");
