...
@FacesComponent(createTag = true, namespace="http://www.edunola.com.ar/uicomponents", tagName="textarea", value="textarea")
public class TextArea extends UIComponentBase{
    ...
    public void encodeBegin(FacesContext context) throws IOException {
        ...
        writer.write(api.imprimirComponente("textarea", valores));
    }
