...
@FacesComponent(createTag = true, namespace="http://www.edunola.com.ar/uicomponents", tagName="selectFull", value="selectFull")
public class SelectFull extends UIComponentBase{
