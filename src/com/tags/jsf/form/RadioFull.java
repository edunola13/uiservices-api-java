...
@FacesComponent(createTag = true, namespace="http://www.edunola.com.ar/uicomponents", tagName="radioFull", value="radioFull")
public class RadioFull extends UIComponentBase{
    ...
    public void encodeBegin(FacesContext context) throws IOException {
        ...
        writer.write(api.imprimirComponente("radio", valores));
    }
